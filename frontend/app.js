...
function loadQuizState() {
    let savedIndex = localStorage.getItem('quizIndex');
    let savedScore = localStorage.getItem('quizScore');

    if(savedIndex !== null){
        corrCount = parseInt(savedScore) || 0 ;
        renderQuestion(parseInt(savedIndex) || 0);
    } else {
        renderQuestion(0);
    }
}
